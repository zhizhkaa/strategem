...
urlpatterns = [
    ...
    path(
        "groups/<int:group_id>/export/excel/",
        GroupGamesExcelExportView.as_view(),
        name="group-games-excel-export",
    ),
    path("admin/settings/", GlobalSettingsView.as_view(), name="admin-settings"),
    path("admin/config-files/", ConfigFilesView.as_view(), name="admin-config-files"),
    path(
        "admin/config-files/<str:filename>/",
        ConfigFileDetailView.as_view(),
        name="admin-config-file-detail",
    ),
    path(
        "admin/config-files/<str:filename>/validate/",
        ConfigFileValidateView.as_view(),
        name="admin-config-file-validate",
    ),
    path(
        "admin/config-files/<str:filename>/reset/",
        ConfigFileResetView.as_view(),
        name="admin-config-file-reset",
    ),
